	...
	return (
		<>
			<motion.button
				...
				whileTap={{ scale: 0.95 }}
				className="absolute -top-2 -right-2 p-2.5 md:p-1.5 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl
			...
			>
				<X size={16} className="md:w-3 md:h-3 text-red-600 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300" />
			</motion.button>

			<motion.button
				whileHover={{ scale: 1.1, y: -1 }}
				whileTap={{ scale: 0.95 }}
				className="absolute -top-2 -left-2 p-2.5 md:p-1.5 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-xl
			...
			>
				<Maximize2 size={16} className="md:w-3 md:h-3 text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300" />
			</motion.button>
		</>
	)
}
