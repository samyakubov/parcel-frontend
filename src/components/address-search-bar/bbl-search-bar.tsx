...
function BblSearchBar() {
    ...
    return (
        <div className="relative shadow-xl rounded-full">
            <div className="flex gap-2 p-1.5 bg-background/80 dark:bg-background/60 backdrop-blur-xl border border-white/20 
            dark:border-white/10 rounded-full transition-all duration-300 hover:shadow-2xl hover:bg-background/90 dark:hover:bg-background/70">
                <Input
                ...
                />
                <Button
                    className="rounded-full px-6 h-11 text-base font-semibold 
